...
export const CONTENT_DIRECTORY: DirectoryEntry[] = [
  ...
  {
    id: 'section-scope',
    title: 'Scope & context isolation',
    description: 'Designing your search scope: which repos belong in it, and when to split one directory into several indexes.',
    tab: 'scope',
    category: 'Section',
    keywords: ['scope', 'context', 'isolation', 'multiple indexes', 'repositories', 'boundary'],
  },
  {
    id: 'section-cli',
  ...
  /* ---------------------------------------------------------------- Concepts */
  {
    id: 'concept-scope-default',
    title: 'Default scope per project',
    description: 'The repositories: list in .agents/local-search-config.yaml is the normal context every session starts with.',
    tab: 'scope',
    category: 'Concept',
    keywords: [
      'default scope',
  ...
  {
    id: 'concept-scope-on-demand',
    title: 'Extending scope for one task',
    description: 'Name an extra repo in the prompt or with --scope / --repos instead of widening the project default.',
    tab: 'scope',
    category: 'Concept',
    keywords: [
      '--scope',
  ...
  {
    id: 'concept-scope-authority',
    title: 'Reality, intent and research',
    description: 'Shipped docs, in-flight proposals and unvalidated notes describe different realities and carry different authority.',
    tab: 'scope',
    category: 'Concept',
    keywords: [
      'authority',
  ...
  {
    id: 'concept-multiple-indexes',
    title: 'Multiple indexes from one directory',
    description: 'Register current-reality, components, work-in-progress, research and scratchpad as separate repos of one git repo.',
    tab: 'scope',
    category: 'Concept',
    keywords: [
      'multiple indexes',
      ...
      'subdirectory',
      'repo add',
      'one repo many indexes',
      'separate',
    ],
  },
  {
    id: 'concept-scope-walkthrough',
    title: 'A granular setup, end to end',
    description: 'Five steps: the directory, registering each part, confirming the split, scoping per project, seeing the isolation.',
    tab: 'scope',
    category: 'Concept',
    keywords: [
      'walkthrough',
  ...
  {
    id: 'concept-scope-isolation',
    title: 'Isolating context between indexes',
    description: 'Why a global search mixes realities, and how the repo becomes the first relevance boundary before semantic ranking.',
    tab: 'scope',
    category: 'Concept',
    keywords: [
      'isolate context',
  ...
  {
    id: 'concept-scope-double-index',
    title: 'The double-indexing trap',
    description: 'Registering both a parent and its subdirectories indexes every file twice; --skip-directory excludes noisy children.',
    tab: 'scope',
    category: 'Concept',
    keywords: [
      'double indexing',
  ...
  {
    id: 'concept-scope-naming',
    title: 'Naming indexes by authority',
    description: 'platform-current-reality beats docs: the name should say what the content is and how much to trust it.',
    tab: 'scope',
    category: 'Concept',
    keywords: [
      'naming',
  ...
  {
    id: 'concept-scope-tips',
    title: 'Tips for setting up multiple indexes',
    description: 'Nine recommendations: split on meaning not size, keep risky indexes out of defaults, rescan per index, and more.',
    tab: 'scope',
    category: 'Concept',
    keywords: [
      'tips',
  ...
  {
    id: 'concept-scope-verify',
    title: 'Verify the split',
    description: 'repo list, scope show, then a scoped find on a term that appears in several indexes - the real check.',
    tab: 'scope',
    category: 'Concept',
    keywords: [
      'verify',
  ...
  {
    id: 'concept-scope-principles',
    title: 'Principles of scope design',
    description: 'Seven rules, from configuring the normal context to asking the agent for traceability of every source it used.',
    tab: 'scope',
    category: 'Concept',
    keywords: [
      'principles',
  ...
  {
    id: 'config-scope-repositories',
    title: 'Choosing what goes in repositories:',
    description: 'The design side of the repositories: key - which repos belong in a project scope, and when to split one into several.',
    tab: 'scope',
    category: 'Config',
    keywords: [
      'repositories',
      'which repos',
      'local-search-config.yaml',
      'project scope',
      'graph: prefix',
      'design',
    ],
